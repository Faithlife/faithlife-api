...
BaseApiClient.prototype.subapp = function subapp() {
  ...
  app.use(function (request, response, next) {
    if (!request.authorization) {
      console.warn([
        'No Authorization header has been provided to the proxy.',
        'It is highly recommended to use faithlife-api with faithlife-oauth.',
        'If faithlife-oauth is being used, please check its configuration.'
      ].join('\n'));
    }
